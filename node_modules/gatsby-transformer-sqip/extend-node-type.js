...
module.exports = function _callee(args) {
  var name;
...
function sqipSharp(_ref) {
  var type, cache, getNodeAndSavePathDependency, store, program, cacheDir;
  return _regenerator.default.async(function sqipSharp$(_context3) {
    while (1) {
      switch (_context3.prev = _context3.next) {
        case 0:
          type = _ref.type, cache = _ref.cache, getNodeAndSavePathDependency = _ref.getNodeAndSavePathDependency, store = _ref.store;
          program = store.getState().program;
          cacheDir = resolve(program.directory + "/node_modules/.cache/gatsby-transformer-sqip/");
          _context3.next = 5;
          return _regenerator.default.awrap(ensureDir(cacheDir));
          ...
          return _context3.abrupt("return", {
            sqip: {
              ...
              resolve: function resolve(image, fieldArgs, context) {
                ...
                return _regenerator.default.async(function resolve$(_context2) {
                  while (1) {
                    switch (_context2.prev = _context2.next) {
                      case 0:
                        ...
                        _context2.next = 6;
                        return _regenerator.default.awrap(queueImageResizing({
                          file: file,
                          args: sharpArgs
                        }));
                      ...
                      case 6:
                        job = _context2.sent;
                        _context2.next = 9;
                        return _regenerator.default.awrap(fs.exists(job.absolutePath));
                      ...
                      case 9:
                        ...
                        _context2.next = 13;
                        return _regenerator.default.awrap(job.finishedPromise);
...
function sqipContentful(_ref2) {
  var type, cache, store, _require6, _require6$schemes, ImageResizingBehavior, ImageCropFocusType, cacheImage, program, cacheDir;

  return _regenerator.default.async(function sqipContentful$(_context5) {
    while (1) {
      switch (_context5.prev = _context5.next) {
        case 0:
          type = _ref2.type, cache = _ref2.cache, store = _ref2.store;
          ...
          return _context5.abrupt("return", {
            sqip: {
              ...
              resolve: function resolve(asset, fieldArgs, context) {
                ...
                return _regenerator.default.async(function resolve$(_context4) {
                  while (1) {
                    switch (_context4.prev = _context4.next) {
                      ...
                      case 3:
                        ...
                        _context4.next = 9;
                        return _regenerator.default.awrap(cacheImage(store, asset, options));

                      case 9:
                        absolutePath = _context4.sent;
                        _context4.next = 12;
                        return _regenerator.default.awrap(md5File(absolutePath));
